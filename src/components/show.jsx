...
const Show = ({
  ...
  useEffect(() => {
    async function fetch() {
      const res = await api.get(`/api/campground/${id}`);
      setcamp(res.data);
      setspin(false);
      if (res.data.error) {
                    ...
                    <div className="col-lg-6 ">
                      <div className="card">
                        <div className="card-body">
                          ...
                          >
                            <div className="carousel-inner show-img">
                        ...
                        {currentUser && camp.author._id === currentUser._id && (
                          <Fragment>
                            <div className="row card-body">
                              <div className="col-md-6 mb-3 mb-md-0 d-grid">
                                <Link
                                  to={`/campground/${camp._id}/edit`}
