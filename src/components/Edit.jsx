...
const Edit = ({ setAlert }) => {
  ...
  useEffect(() => {
    async function fetch() {
      const res = await api.get(`/api/campground/${id}/edit`);
      setcamp(res.data);
      setinput(true);
      setspin(false);
      if (res.data.error) {
                    ...
                    >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          name="location"
                          id="loc"
                          value={inputs.campground.location}
                          required
                        />
                        <div className="valid-feedback mb-3">Looks good!</div>
                      </div>
                      ...
                      <textarea
                        ...
                        id="desc"
                        required
                        value={inputs.campground.description}
                      />
                      <div className="valid-feedback mb-3"> Looks good!</div>
                      ...
                      <div className="row card-body px-0">
                        <div className="col-md-6 d-grid mb-3 mb-md-0">
                          <Link
                            to={`/campground/${camp._id}/editphoto`}
